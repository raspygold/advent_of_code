...
# This is the _very_ slow way.
# After modifying the initial states for register `a` starting from 7 it was clear the pattern is number_of_eggs factorial, plus a constant of 5325. So before this method returned I had calculated the answer manually:
#
# (1..12).inject(:*) + 5235
# => 479006925
